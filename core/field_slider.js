...
console.log('HELP PLEZ');

/**
 * Class for a matrix field.
 * @param {list} slider The default list value of a slider.
 ...
 * @const
 */
Blockly.FieldSlider.SLIDER_HEIGHT = 200;
 ...
 * @const
 */
Blockly.FieldSlider.SLIDER_WIDTH = 30;
...
Blockly.FieldMatrix.prototype.showEditor_ = function() {
  ...
  for (var n = 0; n < 5; n++) {
    var x = (Blockly.FieldMatrix.SLIDER_WIDTH * n) +
      (Blockly.FieldMatrix.SLIDER_WIDTH * (n + 1));
    var y = (Blockly.FieldMatrix.SLIDER_HEIGHT) +
      (Blockly.FieldMatrix.SLIDER_HEIGHT);
    var attr = {
      'x': x + 'px', 'y': y + 'px',
...
Blockly.FieldMatrix.prototype.createButton_ = function(fill) {
  var button = Blockly.utils.createSvgElement('svg', {
    ...
    'xmlns:xlink': 'http://www.w3.org/1999/xlink',
    'version': '1.1', 
    'height': Blockly.FieldMatrix.SLIDER_HEIGHT + 'px',
    'width': Blockly.FieldMatrix.SLIDER_WIDTH + 'px'
  });
  var nodeSize = Blockly.FieldMatrix.SLIDER_HEIGHT;
  var nodePad = Blockly.FieldMatrix.SLIDER_WIDTH;
  for (var i = 0; i < 3; i++) {
    for (var n = 0; n < 3; n++) {
